...
// //                             <span className="text-white font-bold text-xl">DTH Pro</span>
// //                         </Link>
// //                     </div>
...
// //                         <Link to="/cart" className="text-white hover:bg-indigo-500 p-2 rounded-full">
// //                             <ShoppingCart className="h-6 w-6" />
// //                         </Link>
// //                         <Link to="/account" className="text-white hover:bg-indigo-500 p-2 rounded-full">
...
// //                             Services
// //                         </Link>
// //                         {/* <Link to="/cart" className="text-white hover:bg-indigo-500 block px-3 py-2 rounded-md">
// //                             Cart
// //                         </Link>
// //                         <Link to="/account" className="text-white hover:bg-indigo-500 block px-3 py-2 rounded-md">
// //                             Account
// //                         </Link> */}
// //                     </div>
...
// //                                 <Link
// //                                     to="/cart"
// //                                     className="relative p-2 text-white hover:text-indigo-500"
// //                                 >
// //                                     <ShoppingCart className="h-6 w-6" />
// //                                     {totalItems > 0 && (
...
// //                             <Link
// //                                 to="/login"
// //                                 className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-indigo-600 bg-white"
// //                             >
// //                                 Sign in
// //                             </Link>
// //                         )}
...
// // import { useAuth } from '../../context/AuthContext';
// // import { useCart } from '../../context/CartContext';
// // import { ShoppingCart, User, LogOut, Satellite, Router, Cable } from 'lucide-react';
